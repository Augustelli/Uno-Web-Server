...
# Configuración
# =========================
LLM_URL = os.getenv("LLM_URL", "http://vllm:9000/v1/chat/completions")
...
DB_USER_PASSWORD = os.getenv("DB_USER_PASSWORD", "Sup3rSecret0")
DB_MIN_POOL = os.getenv("DB_MIN_POOL", "1")
DB_MAX_POOL = os.getenv("DB_MAX_POOL", "10")
...
async def startup_event():
    ...
    db_pool = await asyncpg.create_pool(
        ...
        min_size=int(DB_MIN_POOL),
        max_size=int(DB_MAX_POOL)
    )
